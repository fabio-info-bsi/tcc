            ...
            <div class="row">
                <div class="col-sm-12 col-md-7 col-xs-12">
                    <div style="margin: 20px">
                        ...
                        echo $this->Html->div('row', $this->Form->input('nm_brinde', array('div' => 'col-xs-12', 'data-toggle' => 'tooltip', 'data-original-title' => __('nm_brinde'), 'title' => __('nm_brinde'), 'class' => 'form-control input-sm')), array('escape' => false));
                        ...
                        echo $this->Html->div('row', $this->Form->input('nm_icon', array('div' => 'col-xs-12', 'data-toggle' => 'tooltip', 'data-original-title' => __('nm_icon'), 'title' => __('nm_icon'), 'class' => 'form-control input-sm')), array('escape' => false));
                        ?><div data-original-title='<?= __('room_id') ?>' data-toggle="tooltip">
                            <?php //ssssecho $this->Html->div('row', $this->Form->input('room_id', array('div' => 'col-xs-12', 'class' => 'form-control input-sm selectpicker', 'data-style' => 'btn-primary', 'data-live-search' => 'true', 'style' => 'width:100%', 'empty' => __('room_id'))), array('escape' => false)); ?>
                        </div><?php
