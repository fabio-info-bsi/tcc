        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                    <thead>
                        <tr>
                            <th><?php echo $this->Paginator->sort('ds_brinde', __('nm_brinde'), array('data-toggle' => 'tooltip', 'data-original-title' => __('nm_brinde'), 'title' => __('nm_brinde'))); ?></th>
                    ...
                    <tbody>
                        <tr>
                            <?php $base_url = array('controller' => 'Rewards', 'action' => 'teacher_index'); ?>
                            <?php echo $this->Form->create("Filter", array('url' => $base_url, 'class' => 'filter')); ?>
                            <td><?php echo $this->Html->div('row', $this->Form->input('nm_brinde', array('div' => 'col-xs-12', 'style' => 'width:100%', 'label' => '', 'data-toggle' => 'tooltip', 'data-original-title' => __('nm_brinde'), 'title' => __('nm_brinde'), 'class' => 'form-control input-sm')), array('escape' => false)); ?></td>
                                    ...
                                    <div class="pull-right">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary', 'escape' => false)), $this->Html->url(array('action' => 'teacher_edit', $reward['Reward']['id'])), array('escape' => false)); ?></li>
