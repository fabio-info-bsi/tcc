<section class="content-header">
    <h1>
        <?php echo __('Points'); ?>
        <small><?php echo __('Edit') . ' ' . __('Point'); ?></small>
    </h1>
    <?php
    $this->Html->addCrumb(__(' Home'), '/', ['i', 'class' => 'fa fa-dashboard']);
    $this->Html->addCrumb(__('Points'), '/Points');
    $this->Html->addCrumb(__('Edit Point'));
    echo $this->Html->getCrumbList(['class' => 'breadcrumb', 'lastClass' => 'active']);
    ?>
</section>
<div class="points form" style="margin: 20px" >
            ...
            <div class="row">
                <div class="col-sm-12 col-md-7 col-xs-12">
                    <div style="margin: 20px">
                        ...
                        echo $this->Html->div('row', $this->Form->input('vl_point', array('div' => 'col-xs-12', 'data-toggle' => 'tooltip', 'data-original-title' => __('vl_point'), 'title' => __('vl_point'), 'class' => 'form-control input-sm')), array('escape' => false));
