        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <tbody>
                        <tr>
                            <?php $base_url = array('controller' => 'Matriculations Rewards', 'action' => 'teacher_index'); ?>
                        ...
                        <?php foreach ($matriculationsRewards as $matriculationsReward): ?>
                            <tr>
                                <td><?php
                                            //debug($matriculationsReward)or die;
                                    if ($matriculationsReward['MatriculationsReward']['active'] == 'S') {
                                    ...
                                    ?></td>
                                <td>
                                    <?php echo $matriculationsReward['Matriculation']['id']; ?>
                                </td>
                                <td style="text-align: center">
                                    <i class="fa <?php echo $matriculationsReward['Reward']['nm_icon'];  ?>"></i>
                                </td>
                                <td style="text-align: center">
                                    <?php echo $matriculationsReward['Activity']['nm_activity']; ?>
                                </td>
                                    ...
                                    <div class="pull-right">
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary', 'escape' => false)), $this->Html->url(array('action' => 'teacher_edit', $matriculationsReward['MatriculationsReward']['id'])), array('escape' => false)); ?></li>
