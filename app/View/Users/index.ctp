        ...
        <div class="table-responsive">
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('username',__('username'),array('data-toggle'=>'tooltip','data-original-title'=>__('username'),'title'=>__('username'))); ?></th>
                            <th><?php echo $this->Paginator->sort('password',__('password'),array('data-toggle'=>'tooltip','data-original-title'=>__('password'),'title'=>__('password'))); ?></th>
                            <th><?php echo $this->Paginator->sort('group_id',__('group_id'),array('data-toggle'=>'tooltip','data-original-title'=>__('group_id'),'title'=>__('group_id'))); ?></th>
                            <th><?php echo $this->Paginator->sort('status',__('status'),array('data-toggle'=>'tooltip','data-original-title'=>__('status'),'title'=>__('status'))); ?></th>
                	...
                	<tbody>
                	    <tr>
                    	    ...
                    	    <?php echo $this->Form->create("Filter",array('url' => $base_url, 'class' => 'filter'));?>
                    	    					 <td><?php echo $this->Html->div('row',$this->Form->input('username',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('username'),'title'=>__('username'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
					 <td><?php echo $this->Html->div('row',$this->Form->input('password',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('password'),'title'=>__('password'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
                                            <td><div data-original-title='<?=__('group_id')?>' data-toggle="tooltip"><?php echo $this->Form->input('group_id', array('label' => '','default' => '','type'=>'select','class'=>'form-control input-sm selectpicker','data-style'=>'btn-primary','data-live-search'=>'true','style'=>'width:100%','empty' => __('group_id')));?></div></td>
                                            					 <td><?php echo $this->Html->div('row',$this->Form->input('status',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('status'),'title'=>__('status'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $user['User']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $user['User']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $user['User']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $user['User']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
