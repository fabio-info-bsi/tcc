            ...
            <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                	<thead>
                	   <tr>
                    	<th><?php echo $this->Paginator->sort('name',__('name'),array('data-toggle'=>'tooltip','data-original-title'=>__('name'),'title'=>__('name'))); ?></th>
                            <th><?php echo $this->Paginator->sort('alias',__('alias'),array('data-toggle'=>'tooltip','data-original-title'=>__('alias'),'title'=>__('alias'))); ?></th>
                	...
                	<tbody>
					 ...
					 <td><?php echo $this->Html->div('row',$this->Form->input('alias',array('div'=>'col-xs-12','style'=>'width:100%','label'=>'','data-toggle'=>'tooltip','data-original-title'=>__('alias'),'title'=>__('alias'),'class'=>'form-control input-sm')),array('escape'=>false));?></td>
<?php $options = array('S' => __('Active'),'N' => __('Inactive'));?>
						...
						<td><?php echo h($group['Group']['alias']); ?>&nbsp;</td>
							<td><?php if($group['Group']['active'] == 'S'){
								...
								<div class="pull-right">
									<div class="btn-group">
										...
										<ul class="dropdown-menu pull-right" role="menu">
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'view', $group['Group']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary','escape' => false)), $this->Html->url(array('action' => 'edit', $group['Group']['id'])), array('escape' => false)); ?></li>
											<li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $group['Group']['id']),array('escape'=>false),__('Are you sure you want to delete the %s?', $group['Group']['id']),array('class' => 'btn btn-mini'));?> </li>
										</ul>
									</div>
								</div>
							</td>
