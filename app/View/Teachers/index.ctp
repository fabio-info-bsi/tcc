<section class="content-header">
    ...
    $this->Html->addCrumb(__('Teachers'));
    echo $this->Html->getCrumbList(['class' => 'breadcrumb', 'lastClass' => 'active']);
    ?>

</section>
<section class="content">
    <div class="teachers index" style="margin: 20px" >
            ...
            <div class="table-responsive">
                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                    <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                <th><?php echo $this->Paginator->sort('nm_teacher', __('nm_teacher'), array('data-toggle' => 'tooltip', 'data-original-title' => __('nm_teacher'), 'title' => __('nm_teacher'))); ?></th>
                                <th class="actions col-xs-1"><?php echo __('Actions'); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                <?php $base_url = array('controller' => 'Teachers', 'action' => 'index'); ?>
                                <?php echo $this->Form->create("Filter", array('url' => $base_url, 'class' => 'filter')); ?>
                                <td><?php echo $this->Html->div('row', $this->Form->input('nm_teacher', array('div' => 'col-xs-12', 'style' => 'width:100%', 'label' => '', 'data-toggle' => 'tooltip', 'data-original-title' => __('nm_teacher'), 'title' => __('nm_teacher'), 'class' => 'form-control input-sm')), array('escape' => false)); ?></td>
                            ...
                            <?php foreach ($teachers as $teacher): ?>
                                <tr>
                                    <td><?php echo h($teacher['Teacher']['nm_teacher']); ?>&nbsp;</td>
                                        ...
                                        <div class="pull-right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right" role="menu">
                                                    <li><?php echo $this->Html->link($this->Html->tag('i', __(' View'), array('class' => 'fa fa-eye fa-fw'), array('class' => 'btn btn-primary', 'escape' => false)), $this->Html->url(array('action' => 'view', $teacher['Teacher']['id'])), array('escape' => false)); ?></li>
                                                    <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary', 'escape' => false)), $this->Html->url(array('action' => 'edit', $teacher['Teacher']['user_id'])), array('escape' => false)); ?></li>
                                                    <li><?php echo $this->Form->postLink($this->Html->tag('i', __(' Delete'), array('class' => 'fa fa-trash-o fa-fw')), array('action' => 'delete', $teacher['Teacher']['id']), array('escape' => false), __('Are you sure you want to delete the %s?', $teacher['Teacher']['id']), array('class' => 'btn btn-mini')); ?> </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
