                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-xs-12">
                        <div style="margin: 20px">
                            <?php
                            echo $this->Html->div('row', $this->Form->input('Teacher.nm_teacher', array('div' => 'col-xs-12', 'data-toggle' => 'tooltip', 'data-original-title' => __('nm_teacher'), 'title' => __('nm_teacher'), 'class' => 'form-control input-sm')), array('escape' => false));
