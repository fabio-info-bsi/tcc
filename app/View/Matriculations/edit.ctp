                ...
                <div class="row">
                    <div class="col-sm-12 col-md-7 col-xs-12">
                        <div style="margin: 20px">
                            ...
                            ?><div data-original-title='<?= __('student_id') ?>' data-toggle="tooltip">
                            ...
                            </div><?php ?><div data-original-title='<?= __('room_id') ?>' data-toggle="tooltip">
