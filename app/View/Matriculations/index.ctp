            ...
            <div class="table-responsive">
                <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid" style="margin: 20px">                 
                    <table  class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            <tr>
                                <?php $base_url = array('controller' => 'Matriculations', 'action' => 'index'); ?>
                            ...
                            <?php foreach ($matriculations as $matriculation): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $this->Html->link($matriculation['Room']['id'], array('controller' => 'rooms', 'action' => 'view', $matriculation['Room']['id'])); ?>
                                    </td>
                                        ...
                                        <div class="pull-right">
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu pull-right" role="menu">
                                                    ...
                                                    <li><?php echo $this->Html->link($this->Html->tag('i', __(' Edit'), array('class' => 'fa fa-edit fa-fw'), array('class' => 'btn btn-primary', 'escape' => false)), $this->Html->url(array('action' => 'edit', $matriculation['Matriculation']['id'])), array('escape' => false)); ?></li>
